...
@fig-boxpl1 shows the similarity in the distributions of BMI by year. The median BMI (the line inside the box) for each year appears fairly consistent across 2008 to 2012. There is no significant upward or downward trend observable from the medians. The range of BMIs (as indicated by the boxes and whiskers) and the presence of outliers (individual points beyond the whiskers) also remain consistent. This shows although individual BMI values vary, the overall distribution of BMIs has not altered significantly over the years.\
